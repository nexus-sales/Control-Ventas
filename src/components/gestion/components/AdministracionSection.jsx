...
import { Trash2, Shield, Lock, FileText, Download } from "lucide-react";
...
const AdministracionSection = React.memo(() => {
        ...
        return (
            <div className="max-w-md mx-auto mt-16 p-8 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-gray-800">
                <div className="flex flex-col items-center mb-6">
                    ...
                    <p className="text-slate-500 dark:text-gray-400 text-sm text-center mt-2">Introduce la clave de gerente para gestionar acuerdos y comisiones maestras.</p>
                </div>
                ...
                <form onSubmit={handleClaveSubmit} className="space-y-4">
                    <div>
                        <input
                            type="password"
                            className="w-full border border-slate-300 dark:border-gray-700 rounded-xl px-4 py-3 bg-white dark:bg-gray-800 text-slate-900 dark:text-white placeholder-slate-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none"
                            placeholder="••••••••"
                            value={clave}
                    ...
                    <button
                        type="submit"
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl transition-all shadow-lg hover:shadow-blue-500/20 active:scale-[0.98]"
                    >
                        Validar Acceso
                    </button>
                </form>
    ...
    return (
        <section className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-gray-400 mt-1">Configuración de comisiones y acuerdos con operadores.</p>
                </div>
                <div className="bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 px-4 py-2 rounded-full text-xs font-bold border border-blue-100 dark:border-blue-800 flex items-center gap-2">
                    <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></div>
                    SESIÓN DE GERENTE ACTIVA
                </div>
            </div>
            ...
            <div className="space-y-4">
                <h3 className="text-xl font-bold text-slate-800 dark:text-white px-1">Historial de Acuerdos Vigentes</h3>
                {acuerdos.length === 0 ? (
